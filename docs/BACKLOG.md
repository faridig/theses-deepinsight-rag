...
| **PBI-022** | **Migration Qdrant Production** | Bascule de ChromaDB vers Qdrant (gRPC, performance, Cloud-Ready). | SPRINT | MOYENNE |
...
| **PBI-013** | **Nightly Audit Ragas** | Pipeline d'évaluation auto sur traces Phoenix réelles. | SPRINT | HAUTE |
