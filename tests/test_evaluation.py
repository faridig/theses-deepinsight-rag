...
class TestThesesEvaluator:
    ...
    @patch('src.evaluation.evaluator.embedding_factory')
    def test_evaluator_initialization(self, mock_emb_factory, mock_llm_factory, mock_openai_client):
    ...
    def test_evaluate_engine(self, mock_run_config, mock_evaluate, mock_emb_factory, mock_llm_factory, mock_openai_client):
        evaluator = ThesesEvaluator()
