...
class TestThesesEvaluator:
    ...
    def test_evaluator_initialization(self, mock_emb_class, mock_llm_factory, mock_openai_client):
    ...
    def test_evaluate_engine(self, mock_run_config, mock_evaluate, mock_emb_class, mock_llm_factory, mock_openai_client):
        evaluator = ThesesEvaluator()
